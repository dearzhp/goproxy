...
import (
	...
	encryptconn "github.com/dearzhp/goproxy/core/lib/transport/encrypt"
	sdk "github.com/dearzhp/goproxy/sdk/android-ios"
	services "github.com/dearzhp/goproxy/services"
	httpx "github.com/dearzhp/goproxy/services/http"
	keygenx "github.com/dearzhp/goproxy/services/keygen"
	mux "github.com/dearzhp/goproxy/services/mux"
	socksx "github.com/dearzhp/goproxy/services/socks"
	spsx "github.com/dearzhp/goproxy/services/sps"
	tcpx "github.com/dearzhp/goproxy/services/tcp"
	tunnelx "github.com/dearzhp/goproxy/services/tunnel"
	udpx "github.com/dearzhp/goproxy/services/udp"
...
func initConfig() (err error) {
	...
	spsArgs.Always = sps.Flag("always", "always use parent proxy").Default("false").Bool()
	spsArgs.Interval = sps.Flag("interval", "check domain if blocked every interval seconds").Default("10").Int()
	spsArgs.Blocked = sps.Flag("blocked", "blocked domain file , one domain each line").Default("blocked").Short('b').String()
	spsArgs.Direct = sps.Flag("direct", "direct domain file , one domain each line").Default("direct").Short('d').String()
